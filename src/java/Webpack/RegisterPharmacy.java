...
public class RegisterPharmacy extends HttpServlet {
    String pid, pname, gstn, email, phone, address, pincode, password, status = "OPERATIONAL", pidNum;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                ops = (OraclePreparedStatement) oconn.prepareCall("INSERT INTO PHARMACY(PID,PNAME,PASSWORD,ADDRESS,GSTN,EMAIL,PHONE,STATUS,PINCODE) VALUES(?,?,?,?,?,?,?,?,?)");
                ops.setString(1,pid);
